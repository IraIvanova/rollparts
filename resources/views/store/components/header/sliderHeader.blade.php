<div class="rp-slide-menu-area" id="slide-sidebar-menu">
    <div class="rp-slide-menu-bg"></div>
    <div class="rp-slide-menu-content slide-sidebar-menu-content">
        <div class="rp-slide-menu-close" id="slide-menu-close">
        ...
        <ul>
            ...
            <li class="p-2">
                <a href="{{ route('cart') }}" class="d-flex">
                    ...
                    <b class="header-cart-total"><span class="rp-Price-amount amount"><span
                                class="rp-currencySymbol">{{ trans('interface.shoppingCart') }} </span></span></b>
