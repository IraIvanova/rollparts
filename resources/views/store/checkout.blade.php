                        ...
                        <div>
                            <div class="row px-3">
                                <div class="form-row form-row-wide validate-required w-50 @error('name') invalid @enderror">
                                    ...
                                    <input type="text" class="input-text rp-form-row-Input"
                                           name="name"
                                           id="firstName" placeholder="" value="{{$user->name ?? old('name') ?? ''}}">
                                </div>
                            ...
                            <div class="form-row form-row-wide validate-required @error('phone') invalid @enderror">
                                ...
                                <input type="text" class="input-text rp-form-row-Input"
                                       ...
                                       id="phone" placeholder="" value="{{$user->phone ?? old('phone') ?? ''}}">
                            </div>
                            <div class="form-row form-row-wide validate-required @error('email') invalid @enderror">
                                ...
                                <input type="email" class="input-text rp-form-row-Input"
                                       name="email"
                                       id="email" placeholder="" value="{{$user->email ?? old('email') ?? ''}}"
                                       required>
                            </div>
                            <div class="form-row form-row-wide validate-required @error('identity') invalid @enderror">
                                <label for="identity" class="">{{trans('interface.checkout.identityId')}}*</label>
                                <input type="text" class="input-text rp-form-row-Input"
                                       name="identity"
                                       id="identity" placeholder="" value="{{$user->identity ?? old('identity') ?? ''}}"
                                       required>
                            </div>
                        </div>
