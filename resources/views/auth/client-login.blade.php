                        ...
                        <div class="page-content">
                            <div class="row" id="customer_login">
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <form class="rp-form rp-form-card login" method="post"
                                        ...
                                        <p class="form-row align-items-center">
                                            <button type="submit" class="button rp-form-card__submit button-fill-one" name="login"
                                                    value="Log in">{{ trans('interface.buttons.login') }}</button>

                                            <label
                                                class="rp-form__label rp-form__label-for-checkbox rp-form-card__rememberme">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <p class="rp-form-row ">
                                        <a class="button rp-form-register__submit button-fill-one"
